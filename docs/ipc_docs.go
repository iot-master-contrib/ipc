...
// SwaggerInfoipc holds exported Swagger Info so clients can modify it
var SwaggerInfoipc = &swag.Spec{
	Version:          "1.0 版本",
	Host:             "",
	...
	Title:            "历史数据接口文档",
	Description:      "API文档",
	InfoInstanceName: "ipc",
	SwaggerTemplate:  docTemplateipc,
}

func init() {
	swag.Register(SwaggerInfoipc.InstanceName(), SwaggerInfoipc)
}
